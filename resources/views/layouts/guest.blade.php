        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        @foreach($links as $link)
                            <a href="{{ route($link['route']) }}" class="block text-sm text-slate-400 hover:text-primary-400 transition-colors">{{ $link['label'] }}</a>
                        @endforeach
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-sm text-slate-400">
                        ...
                        <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 transition-colors font-medium">
                            Contact Me
