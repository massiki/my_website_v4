<div>
  <div class="flex items-center justify-between mb-6">
    <div class="flex items-center gap-4">
      ...
      <div>
        <h2 class="text-lg font-heading font-semibold text-slate-800">Create Blog Post</h2>
        <p class="text-sm text-slate-500 mt-0.5">Write and publish a new blog article</p>
      </div>
    </div>
  </div>
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div wire:ignore>
          ...
          <trix-editor x-data x-init="$el.addEventListener('trix-change', function(e) {
      ...
      <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div class="flex items-start gap-6">
          ...
          @if ($thumbnailPreview)
            <div class="relative w-32 h-32 sm:w-36 sm:h-36 rounded-xl overflow-hidden border border-slate-200 ">
