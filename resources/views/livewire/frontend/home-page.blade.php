<div>
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                {{-- Text --}}
                <div class="space-y-6">
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 rounded-full text-sm font-medium text-primary-600 shadow-sm">
                    ...
                    <div class="flex flex-wrap gap-4 pt-2">
                        <a href="{{ $heroCta1Url }}" class="btn-primary">
                            {{ $heroCta1 }}
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                        </a>
                        <a href="{{ $heroCta2Url }}" class="btn-outline">
                            {{ $heroCta2 }}
                        </a>
                    </div>
                </div>
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-7 py-3 bg-white text-primary-600 font-semibold rounded-xl hover:bg-cyan-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                    Get In Touch
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                </a>
                <a href="{{ route('projects') }}" class="inline-flex items-center gap-2 px-7 py-3 border-2 border-white/50 text-white font-semibold rounded-xl hover:bg-white/10 transition-all">
                    View Portfolio
                </a>
            </div>
        </div>
